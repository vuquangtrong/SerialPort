...
/*!
    \brief      Constructor of the class SerialPort.
*/
...
/*!
    \brief      Destructor of the class SerialPort. It close the connection
*/
// Class desctructor
SerialPort::~SerialPort()
{
...
/*!
  ...
  */
char SerialPort::openDevice(const char *Device, const unsigned int Bauds,
...
/*!
  ...
  */
char SerialPort::writeChar(const char Byte)
{
#if defined (_WIN32) || defined( _WIN64)
...
/*!
     ...
     \return    -1 error while writting data
  */
char SerialPort::writeString(const char *receivedString)
{
#if defined (_WIN32) || defined( _WIN64)
    // Number of bytes written
    DWORD dwBytesWritten;
...
/*!
     ...
     \return -1 error while writting data
  */
char SerialPort::writeBytes(const void *Buffer, const unsigned int NbBytes)
{
#if defined (_WIN32) || defined( _WIN64)
    // Number of bytes written
    DWORD dwBytesWritten;
...
/*!
  ...
  */
char SerialPort::readChar(char *pByte,unsigned int timeOut_ms)
{
#if defined (_WIN32) || defined(_WIN64)
...
/*!
  ...
  */
int SerialPort::readStringNoTimeOut(char *receivedString,char finalChar,unsigned int maxNbBytes)
{
...
/*!
     ...
     \return -3 MaxNbBytes is reached
  */
int SerialPort::readString(char *receivedString,char finalChar,unsigned int maxNbBytes,unsigned int timeOut_ms)
{
...
/*!
     ...
     \return -2 error while reading the byte
  */
int SerialPort::readBytes (void *buffer,unsigned int maxNbBytes,unsigned int timeOut_ms, unsigned int sleepDuration_us)
{
#if defined (_WIN32) || defined(_WIN64)
...
*/
bool SerialPort::DTR(bool status)
{
    if (status)
        // Set DTR
        return this->setDTR();
...
*/
bool SerialPort::RTS(bool status)
{
    if (status)
        // Set RTS
        return this->setRTS();
